...
<body>
  ...
  <section class="container content">
    <header class="jumbotron subhead" id="overview">
      <h1>Query a, Deliverable 3</h1>
      <p class="lead">List the name of the schools according to the number of players they sent to the NBA. Sort them in descending order by number of drafted players.</p>
      <pre>
