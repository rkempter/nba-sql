...
<body>
          ...
          <ul class="nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="query_3_c.php">Query c</a></li>
  ...
  <section class="container content">
    <header class="jumbotron subhead" id="overview">
      <h1>Query c, Deliverable 3</h1>
      <p class="lead">List the average weight, average height and average age, of teams of coaches with more than XXX season career wins and more than YYY win percentage, in each season they coached. (XXX and YYY are parameters. Try with combinations: {XXX,YYY}={<1000,70%>,<1000,60%>,<1000,50%>,<700,55%>,<700,45%>}. Sort the result by year in ascending order.</p>
      <pre>
