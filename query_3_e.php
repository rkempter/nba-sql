...
<body>
          ...
          <ul class="nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="query_3_e.php">Query e</a></li>
  ...
  <section class="container content">
    <header class="jumbotron subhead" id="overview">
      <h1>Query e, Deliverable 3</h1>
      <p class="lead">List the last and first name of the players who played for a Chicago team and Houston team.</p>
      <pre>
...
UNION
SELECT DISTINCT p.firstname, p.lastname
FROM Player p, PlayoffSeason ps1, PlayoffSeason ps2
WHERE p.pid = ps1.pid AND
      p.pid = ps2.pid AND
      ps1.tid IN (SELECT tid
             FROM Team
             WHERE location = 'Chicago') AND
      ps2.tid IN (SELECT tid
             FROM Team
             WHERE location = 'Houston')
      </pre>
    </header>
